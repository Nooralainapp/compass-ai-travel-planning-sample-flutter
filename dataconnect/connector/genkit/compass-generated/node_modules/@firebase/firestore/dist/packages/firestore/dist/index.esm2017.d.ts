 ...
 */ declare class __PRIVATE_AsyncQueueImpl {
    ...
    Pu: boolean;
    Iu: any[];
    e_: __PRIVATE_ExponentialBackoff;
    Tu: () => void;
 ...
 */ declare class __PRIVATE_UserDataReader {
    ...
    serializer: any;
    /** Creates a new top-level parse context. */ Ou(e: any, t: any, n: any, r?: boolean): __PRIVATE_ParseContextImpl;
}
...
declare class __PRIVATE_ExponentialBackoff {
    ...
    zo(): void;
    cancel(): void;
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ Go(): number;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
/** A "context" object passed around while parsing user data. */ declare class __PRIVATE_ParseContextImpl {
    ...
    get path(): any;
    get yu(): any;
    /** Returns a new context with the specified settings overwritten. */ wu(e: any): __PRIVATE_ParseContextImpl;
...
declare class __PRIVATE_MemoryPersistence {
    ...
    Qr: boolean;
    Kr: __PRIVATE_MemoryGlobalsCache;
    referenceDelegate: any;
    $r: __PRIVATE_MemoryTargetCache;
    ...
    Wr: __PRIVATE_MemoryBundleCache;
    start(): Promise<void>;
    ...
    jr(e: any, t: any): PersistencePromise;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
declare class __PRIVATE_DatastoreImpl extends __PRIVATE_DatastoreImpl_base {
    ...
    p_: boolean;
    y_(): void;
    /** Invokes the provided RPC with auth and AppCheck tokens. */ Fo(e: any, t: any, n: any, r: any): Promise<any>;
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ No(e: any, t: any, n: any, r: any, i: any): Promise<any>;
    terminate(): void;
}
/**
 * @license
 ...
 */ declare class __PRIVATE_RemoteStoreImpl {
    ...
    L_: any[];
    B_: any;
    k_: __PRIVATE_OnlineStateTracker;
}
 ...
 */ declare class __PRIVATE_SyncEngineImpl {
     ...
     */
    Oa: Map<any, any>;
    Na: __PRIVATE_ReferenceSet;
    /** Stores user completion handlers, indexed by User and BatchId. */
    La: {};
    /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    Ba: Map<any, any>;
    ka: __PRIVATE_TargetIdGenerator;
    onlineState: string;
 ...
 */ declare class __PRIVATE_WebStorageSharedClientState {
     ...
     */ Ws(e: any): string | null;
    /**
     * Parses a client state in WebStorage. Returns 'null' if the value could not
     * be parsed.
     */ zs(e: any, t: any): __PRIVATE_RemoteClientState | null;
    /**
     * Parses a mutation batch state in WebStorage. Returns 'null' if the value
     * could not be parsed.
     */ js(e: any, t: any): __PRIVATE_MutationMetadata | null;
    /**
     ...
     * could not be parsed.
     */ Ns(e: any): __PRIVATE_SharedOnlineState | null;
    Zs(e: any): any;
    Hs(e: any): Promise<any>;
    Ys(e: any): any;
    Gs(e: any, t: any): any;
    Ls(e: any): void;
    Bs(e: any): SortedSet;
...
declare class __PRIVATE_IndexedDbPersistence {
    ...
    Ei: (e: any) => Promise<void>;
    referenceDelegate: __PRIVATE_IndexedDbLruDelegateImpl;
    di: string;
    serializer: __PRIVATE_LocalSerializer;
    Ai: __PRIVATE_SimpleDb;
    Kr: __PRIVATE_IndexedDbGlobalsCache;
    $r: __PRIVATE_IndexedDbTargetCache;
    remoteDocumentCache: __PRIVATE_IndexedDbRemoteDocumentCacheImpl;
    Wr: __PRIVATE_IndexedDbBundleCache;
    Ri: any;
    /**
     ...
     */ gi(): void;
    /** Checks whether `client` is the local client. */ Di(e: any): boolean;
    /**
     ...
     */ bi(e: any): any;
    /** Checks the primary lease and removes it if we are the current primary. */ Si(e: any): any;
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ Fi(e: any, t: any): boolean;
    mi(): void;
    Li(): void;
    /**
     ...
     */ Ni(): void;
    /** Removes the zombied client entry if it exists. */ ki(): void;
    xi(e: any): string;
}
/**
 ...
 */ declare class __PRIVATE_RemoteClientState {
     ...
     */ static As(e: any, t: any): __PRIVATE_RemoteClientState | null;
    constructor(e: any, t: any);
    clientId: any;
    activeTargetIds: any;
}
...
declare class __PRIVATE_MutationMetadata {
     ...
     * Logs a warning and returns null if the format of the data is not valid.
     */ static As(e: any, t: any, n: any): __PRIVATE_MutationMetadata | null;
    constructor(e: any, t: any, n: any, r: any);
    user: any;
    batchId: any;
    state: any;
...
declare class __PRIVATE_QueryTargetMetadata {
     ...
     * Logs a warning and returns null if the format of the data is not valid.
     */ static As(e: any, t: any): __PRIVATE_QueryTargetMetadata | null;
    constructor(e: any, t: any, n: any);
    targetId: any;
    state: any;
    error: any;
 ...
 */ declare class __PRIVATE_SharedOnlineState {
     ...
     * Logs a warning and returns null if the format of the data is not valid.
     */ static As(e: any): __PRIVATE_SharedOnlineState | null;
    constructor(e: any, t: any);
    clientId: any;
    onlineState: any;
}
...
declare class __PRIVATE_IndexedDbIndexManager {
     ...
     * bounds.
     */ Tn(e: any, t: any, n: any, r: any, i: any, s: any, o: any): IDBKeyRange[];
    ...
    /** Encodes a single value to the ascending index format. */ En(e: any): Uint8Array;
    /**
...
/** Represents an index entry saved by the SDK in persisted storage. */ declare class __PRIVATE_IndexEntry {
     ...
     * directional value.
     */ Yt(): __PRIVATE_IndexEntry;
}
/**
 * Implements `DirectionalIndexByteEncoder` using `OrderedCodeWriter` for the
 * actual encoding.
 */ declare class __PRIVATE_IndexByteEncoder {
    zt: __PRIVATE_OrderedCodeWriter;
    jt: __PRIVATE_AscendingIndexByteEncoder;
    Ht: __PRIVATE_DescendingIndexByteEncoder;
    seed(e: any): void;
 ...
 */ declare class __PRIVATE_OrderedCodeWriter {
    ...
    Ct(e: any): void;
    Mt(e: any): void;
    /** Writes utf8 bytes into this byte sequence, ascending. */ Nt(e: any): void;
     ...
     */ reset(): void;
    seed(e: any): void;
    /** Makes a copy of the encoded bytes in this buffer.  */ Gt(): Uint8Array;
    /**
    ...
    /** Writes a single byte descending to the buffer.  */ xt(e: any): void;
    Ft(): void;
    Ot(): void;
    $t(e: any): void;
    Wt(e: any): void;
